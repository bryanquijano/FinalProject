<template>
  <div class="flex">
    <div class="mx-auto mt-20">
      <div class="w-72 mr-12">
        <img
          src="../../assets/memberProfiles/mem5.jpg"
          alt=""
          class="w-72 h-72 bg-gray-400 rounded-full"
        />
      </div>
      <div class="w-72 mt-4 text-center">
        <h2 class="text-7xl font-bold">Yoohyeon</h2>
  ...
  <p class="text-center mt-12 mb-4">Want to learn more about Yoohyeon?</p>
  <div class="flex justify-center">
    <iframe
      width="560"
      height="315"
      src="https://www.youtube.com/embed/pzBr7auclYQ"
