  ...
  <div>
    <div class="flex container mx-auto mt-20">
      <div class="w-72 mr-12">
        <img
          src="../../assets/albumCovers/01.jpg"
          alt=""
          class="w-72 h-72 bg-gray-400 rounded-xl"
        />
      </div>
      <div class="w-1200 mt-10">
        <h2 class="text-7xl font-bold">Nightmare</h2>
    ...
    <table class="table-auto w-full text-xl">
      ...
      <tbody>
        <tr>
          ...
          <td class="font-normal">Welcome to Dream</td>
        ...
        <tr>
          ...
          <td class="font-normal">Emotion</td>
        ...
        <tr>
          ...
          <td class="font-normal">Chase Me (Inst.)</td>
