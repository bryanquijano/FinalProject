  ...
  <div>
    <div class="flex container mx-auto mt-20">
      <div class="w-72 mr-12">
        <img
          src="../../assets/albumCovers/02.jpg"
          alt=""
          class="w-72 h-72 bg-gray-400 rounded-xl"
        />
      </div>
      <div class="w-1200 mt-10">
        <h2 class="text-7xl font-bold">Fall Asleep in the Mirror</h2>
        ...
        <span class="text-sm mt-2 text-gray-400"> • 4 songs</span>
        <br />
    ...
    <table class="table-auto w-full text-xl">
      ...
      <tbody>
        <tr>
          ...
          <td class="font-normal">My Toys</td>
        ...
        <tr>
          ...
          <td class="font-normal">Lullaby</td>
        ...
        <tr>
          ...
          <td class="font-normal">Good Night (Inst.)</td>
